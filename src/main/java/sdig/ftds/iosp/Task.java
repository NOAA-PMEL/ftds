...
public class Task {
     ...
     */
    public void run() throws IOSPException {
        ...
        try {
            ...
            if (process == null) {
                throw new IOSPException("creation of child process "
            ...
            throw new IOSPException("creation of child process failed\n"
                    + "command: " + cmdString + ioe.getMessage());
        }
    }
     ...
     */
    public void run(long timeLimit) throws IOSPException {
        ...
        try {
            ...
            throw new IOSPException(lase.getMessage());
        } finally {
